...
copy_fidelity_needles=(
  ...
  'How it runs'
  'Interviews with you and the people who actually touch the work. We map how work really flows through your firm, not how the org chart claims it does. This is where the bodies are buried, and everyone knows exactly where.'
  "Every leak gets a number: hours lost, delay cost, error cost, deals that died of slowness. Consultants are professional skeptics, so we do the math you'd do to us."
  'A working session, not a reveal. We walk the three opportunities, you push back, we defend or concede. You leave knowing your first install, its price, and its success gate. Then you decide. No countdown timer, no "this offer expires".'
  ...
  'your calendar and your priorities, day one.'
  "your ICP and the 200 contacts you've been meaning to call for two years."
  'your last ten meetings.'
  'the honest truth about your current response time.'
  'your aging receivables.'
  'ingesting what your firm already knows and forgot it knew.'
  'the fifty accounts and people you actually care about.'
  "the best material you've already made and stopped using."
  'your onboarding pain.'
  'that workflow. You know the one.'
  'your existing brand assets.'
  'before anything else ships. Always.'
  "Read that again: the only outcome where you lose money is the one where we've already proven we can make you more."
  "It's not a courage problem. It's a system problem."
  "You can't lose. We can."
  "Most vendors call this terrifying. We call it Tuesday."
  "Ten minutes a day, usually over coffee. Every decision is logged, timestamped, and inspectable."
  "It's the first employee who shows you everything before doing anything."
  "First agent live in 30 to 45 days."
  ...
  "Because flat retainers reward showing up and we'd rather be rewarded for moving numbers."
  "The only scenario where you pay for the assessment and nothing else is the one where you take the map and walk. The door is open. Nobody has."
  "Twenty years of executives who take his calls."
  "Still a client. Still approving every message. Next agent installs this quarter."
  "Your network has the same dust on it."
  "hello@welcometotheaijungle.com reaches a person, not a ticket queue."
  "We already tried AI. It wrote like a robot and we quit."
  "People have paid consultants for worse."
  "The choice in front of me was the one in front of you: hire more people I'd have to fund, train and manage, or build a system that carried the weight without diluting my name."
  "One idea a week you can actually install. Real receipts from systems in production, no recycled AI hype. Unsubscribe anytime, no guilt trip."
  "A handful of firms at a time. Not a pose: operating a system takes hours, and we don't sell hours we don't have. When it's full, it's a waitlist."
)
echo 'copy:fidelity'
